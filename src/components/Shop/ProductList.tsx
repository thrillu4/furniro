                    ...
                    <div className="mt-6 flex flex-col xl:flex-row xl:gap-0 gap-3 items-center justify-evenly">
                        ...
                        {isOpenShareModal && (
                            <motion.div initial='hidden' whileInView='visible' className='absolute flex flex-col justify-between inset-0 w-full bg-black p-3 xl:p-10'>
                                ...
                                <AiFillCopy onClick={handleCopyLink} className='block mx-auto cursor-pointer hover:scale-110 duration-200 w-[22px] h-[22px] xl:w-[50px] xl:h-[50px]'/>
                                </div>
                                {copied && (
                                    <div className='fixed bottom-4 left-4 bg-white border border-black text-black rounded-[10px] px-2 py-4 '>Url copied to clipboard</div>
                                )}
                            </motion.div>
                        )}
