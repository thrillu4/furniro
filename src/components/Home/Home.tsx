  ...
  return (
    <>
      <div className="promo relative">
        <img className='w-full hidden md:block' src="images/new-collection.png" alt="collection" />
        <img className='w-full md:hidden block' src="images/phone-wall-7.jpg" alt="collection" />
        <div className="arrival absolute bottom-12 left-12 md:right-0 md:bottom-0  lg:bottom-20 lg:p-2 xl:top-36   2xl:max-w-[643px] xl:max-w-[550px] lg:max-w-[450px] md:max-w-[320px] sm:max-w-[250px] ml-auto bg-[#fff3de] rounded md:bg-yellow-50 p-2 md:p-4 xl:py-16 xl:px-11">
          ...
          <Link to={ROUTES.SHOP} className="inline-block text-center md:mt-[15px] lg:mt-[46px] md:py-4 md:px-5 xl:py-6 lg:px-[45px] xl:px-[74px] font-bold bg-amber-500 text-white text-[10px] md:text-base py-1 px-2 rounded-[5px]">Show More</Link>
        </div>
      </div>
      <div className="range">
      ...
      <div className="our-product">
        ...
        <Link to={ROUTES.SHOP}><button className='block my-0 mx-auto text-[12px] md:text-base font-semibold border border-orange-300 text-orange-400 py-3  md:px-20 px-[20px] mt-4 md:mt-11'>Show More</button></Link>
      </div>
      <div className="slider-component relative md:mt-16">
        <div className='md:mt-56 mt-12 md:ml-4 xl:ml-24 mb-60'>
          ...
          <Link to={ROUTES.BLOG} className='block w-[150px] md:w-[176px] text-xs font-semibold mt-5 md:mt-9 py-3 text-center text-white bg-orange-400'>Explore More</Link>
        </div>
      <Swiper
        effect={'coverflow'}
        breakpoints={{
        ...
        className="mySwiper w-full absolute md:right-0 -bottom-[260px] md:-top-28 lg:right-[40px] lg:-top-32 xl:right-0  xl:-top-36 md:max-w-[444px] lg:max-w-[555px] xl:max-w-4xl"
      >
