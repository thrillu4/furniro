...
const PrivacyPolicy = () => {
  return (
    <div className="md:p-16 p-7">
      <h1 className="md:text-4xl text-xl font-bold mb-8">Privacy Policy</h1>
      <p className="md:text-lg mb-4">
        This Privacy Policy explains how we collect, use, and disclose your personal information when you use our services.
      </p>
      <div className="mb-8">
        <h2 className="md:text-2xl font-bold mb-2"><IoIosInformationCircle className="inline mr-2 text-blue-500" /> Information We Collect</h2>
        <p className="md:text-lg text-[12px] mb-6">
      ...
      <div className="mb-8">
        <h2 className="md:text-2xl font-bold mb-2"><IoIosCheckmarkCircleOutline className="inline mr-2 text-green-500" /> How We Use Your Information</h2>
        <p className="md:text-lg text-[12px] mb-6">
      ...
      <div className="mb-8">
        <h2 className="md:text-2xl font-bold mb-2"><IoIosWarning className="inline mr-2 text-red-500" /> Disclosure of Your Information</h2>
        <p className="md:text-lg text-[12px] mb-6">
      ...
      <h2 className="md:text-2xl font-bold mb-2">Contact Us</h2>
